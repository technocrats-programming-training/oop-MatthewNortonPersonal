...
public class Car {
  ...
  public Car(String model, double mpg, double gasTankCapacity) {
    ...
    this.gasRemaining = 0;
    // "this" refers to a generic object that we do not know the name of yet. This is useful for when we need to assign an instance variable for an object when there are parameters.

  }

  // I don't need to modify main
  ...
  public String toString() {
    ...
    return "Range: " + getRange() + " miles. " + "Model: " + model + ". " + "Gas Level: " + getGasRemaining() + " gallons.";
  }
}
